...
#ifndef YY_CONSTEXPYY_HOME_RCRAIG8_RESEARCH_DOXYBRANCH_DOXYGEN_BUILD_GENERATED_SRC_CE_PARSE_HPP_INCLUDED
# define YY_CONSTEXPYY_HOME_RCRAIG8_RESEARCH_DOXYBRANCH_DOXYGEN_BUILD_GENERATED_SRC_CE_PARSE_HPP_INCLUDED
/* Debug traces.  */
#ifndef CONSTEXPYYDEBUG
# if defined YYDEBUG
#if YYDEBUG
#   define CONSTEXPYYDEBUG 1
#  else
#   define CONSTEXPYYDEBUG 0
#  endif
# else /* ! defined YYDEBUG */
#  define CONSTEXPYYDEBUG 0
# endif /* ! defined YYDEBUG */
#endif  /* ! defined CONSTEXPYYDEBUG */
#if CONSTEXPYYDEBUG
extern int constexpYYdebug;
#endif

/* Token kinds.  */
#ifndef CONSTEXPYYTOKENTYPE
# define CONSTEXPYYTOKENTYPE
  enum constexpYYtokentype
  {
    CONSTEXPYYEMPTY = -2,
    CONSTEXPYYEOF = 0,             /* "end of file"  */
    CONSTEXPYYerror = 256,         /* error  */
    CONSTEXPYYUNDEF = 257,         /* "invalid token"  */
  ...
  typedef enum constexpYYtokentype constexpYYtoken_kind_t;
#endif

/* Value type.  */
#if ! defined CONSTEXPYYSTYPE && ! defined CONSTEXPYYSTYPE_IS_DECLARED
typedef int CONSTEXPYYSTYPE;
# define CONSTEXPYYSTYPE_IS_TRIVIAL 1
# define CONSTEXPYYSTYPE_IS_DECLARED 1
#endif
...
#endif /* !YY_CONSTEXPYY_HOME_RCRAIG8_RESEARCH_DOXYBRANCH_DOXYGEN_BUILD_GENERATED_SRC_CE_PARSE_HPP_INCLUDED  */
