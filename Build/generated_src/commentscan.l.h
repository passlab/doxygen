static const char *stateToString(int state)
{
  switch(state)
  {
    ...
    case ModuleDocArg1: return "ModuleDocArg1";
    ...
    case RaiseWarningSection: return "RaiseWarningSection";
    case Qualifier: return "Qualifier";
    case LinkSection: return "LinkSection";
    case IFile: return "IFile";
    case IFileSection: return "IFileSection";
    case ILine: return "ILine";
    case ILineSection: return "ILineSection";
    case IRaise: return "IRaise";
    case IRaisePrefix: return "IRaisePrefix";
  }
  return "Unknown";
}
